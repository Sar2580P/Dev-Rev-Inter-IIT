...
# def choose_mistake(user_query, mistake, tool_task=None):
#     x = chain.run({'input':user_query,  'mistake': mistake})
#     y =  ast.literal_eval(x)        
#     return y

def analyse(user_query, wrong_tool_name, tool_task=None):
    ...
    #         ans = choose_mistake(user_query , mistake.page_content)
    #         if ans == 1:
    #             i+=1
